describe('ProctoredExamAAllowanceView', function() {
    ...
    beforeEach(function() {
        ...
        allowancesHtml = '<span class="tip">' +
            ...
            '<th class="allowance-name">额外时间类型</th>' +
            '<th class="allowance-value">额外时间</th>' +
